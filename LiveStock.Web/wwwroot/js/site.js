...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (rainfallForm) {
        rainfallForm.addEventListener('submit', function(e) {
            ...
            alert(`Added ${amountMl}ml of rain for Camp ${campNumber}`);
            ...
            if (typeof showCampDetails === 'function' && campNumber) {
                showCampDetails(campNumber);
            }
        });
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Handle rainfall form submission
    const rainfallForm = document.getElementById('rainfallForm');
    if (rainfallForm) {
        rainfallForm.addEventListener('submit', function(e) {
            e.preventDefault();
            ...
            // Close modal
            const modal = bootstrap.Modal.getInstance(document.getElementById('addRainfallModal'));
            if (modal) {
                modal.hide();
            }
        });
