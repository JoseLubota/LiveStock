...
namespace LiveStock.Infrastructure.Migrations
{
    ...
    [Migration("20251028113834_EnsureAnimalStatusColumns")]
    partial class EnsureAnimalStatusColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LiveStock.Core.Models.Asset", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Fencing Wire",
                            PurchaseDate = new DateTime(2023, 11, 2, 0, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            ...
                            Name = "Livestock Feed",
                            PurchaseDate = new DateTime(2023, 12, 2, 0, 0, 0, 0, DateTimeKind.Utc),
                            PurchasePrice = 0.80m,
                            Quantity = 1000,
                            Status = "Active",
                            Type = "Grain Mix",
            ...
            modelBuilder.Entity("LiveStock.Core.Models.FinancialRecord", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Reference = "INV-001",
                            TransactionDate = new DateTime(2023, 12, 22, 0, 0, 0, 0, DateTimeKind.Utc),
                            Type = "Income"
                        },
                        new
                        {
                            ...
                            Reference = "REC-001",
                            TransactionDate = new DateTime(2023, 12, 17, 0, 0, 0, 0, DateTimeKind.Utc),
                            Type = "Expense"
                        },
                        new
                        {
                            ...
                            Reference = "INV-002",
                            TransactionDate = new DateTime(2023, 12, 12, 0, 0, 0, 0, DateTimeKind.Utc),
                            Type = "Expense"
                        });
                });
